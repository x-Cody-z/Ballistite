...
public class Projectile_Ricochet : MonoBehaviour
{
    [Tooltip("the number of times the projectile will bounce before exploding")]
    [SerializeField] private int bounce_counter = 1;
